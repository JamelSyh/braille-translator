...
urlpatterns = [
    path('transcriptor/', views.transcript),
    path('translator/', views.translate),
    path('downloadfile/', views.download_file),
    path('transcript_options/', views.get_transcribe_options),
    path('translate_options/', views.get_translate_options),
    path('contraction_list/', views.get_contraction_list),
    path('search_options/', views.get_search_options, name=""),
